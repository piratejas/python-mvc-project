...
def index():
    ...
    if response.status_code == 200:
        ...
        return render_template('index.html', bids=bids, total=total, limit=limit, offset=offset, sort=sort)
    else:
...
def add_bid():
    ...
    data = Bid(tender=tender, bid_date=bid_date, client=client, alias=alias, bid_folder_url=bid_folder_url, was_successful=was_successful)
    url = "http://localhost:8080/api/bids"
    headers = {"Content-Type": "application/json", "Authorization": "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VybmFtZSI6IlRlc3RlciBNY1Rlc3RmYWNlIiwiYWRtaW4iOmZhbHNlfQ.Dg7f8LVtALYWvjZH31re5C-Pc6Hp6Ra-U4LAy0ZQQ9M"}
